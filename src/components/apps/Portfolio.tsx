...
interface PortfolioState extends ContentProps {
  curSidebar: number;
  curMidbar: number;
...
const Portfolio = () => {
  const [state, setState] = useState<PortfolioState>({
    curSidebar: 0,
    curMidbar: 0,
    midbarList: portfolio[0].md,
    contentID: portfolio[0].md[0].id,
    contentURL: portfolio[0].md[0].file
  });
  ...
  return (
    <div className="portfolio font-avenir flex h-full bg-transparent">
